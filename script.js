var questions = {
	"1" : {
		id: 1,
		title: 'Connect',
		text: 'Start a conversation and connect with your peers.',
		votes: 1,
		responses: [
			{
				name: 'Aram',
				comment: 'Hey guys, I am new on campus and looking to make new friends. Is anyone free in the afternoon today?'
			},
			{
				name: 'Raha',
				comment: 'Hi, yes I am. Can we meet at Huntercommons 4th floor at 12:00 PM?'
			}
		],
		resolved: false,
		favorite:false
	...
	"2" : {
		id: 2,
		title: 'Whats New?',
		text: 'Educate your peers by sharing recent news and facts',
		votes: 3,
		responses: [
			{
				name: 'lars',
				comment: 'Guys, Do You Know? Florida Senator introduced legislation that would disqualify most people with a history of gender dysphoria.'
			},
			{
				name: 'carl',
				comment: 'What?? really?'
	...
	"3" : {
		id: 3,
		title: 'Q&A',
		text: 'Ask and answer your peers',
		votes: 2,
		responses: [
			{
				name: 'Amanda',
				comment: 'Does anyone know where is the Q centre located?'
			},
			{
				name: 'Rahul',
				comment: 'Yes, It is in MSC 210 MacEwan Student Centre.'
			}
		],
		resolved: false,
		favorite:false
